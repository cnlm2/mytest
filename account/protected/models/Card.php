...
class Card extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, type, tags, create_time', 'required'),
			array('id', 'length', 'max'=>64),
			array('type, tags, transcation_id', 'length', 'max'=>50),
			array('consume_time', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, type, tags, create_time, transcation_id, consume_time', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('transcation_id',$this->transcation_id,true);
