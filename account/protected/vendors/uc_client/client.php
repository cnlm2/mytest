...
function uc_user_register($username, $password, $email, $nickname = '', $questionid = '', $answer = '', $regip = '') {
	return call_user_func(UC_API_FUNC, 'user', 'register', array('username'=>$username, 'password'=>$password, 'email'=>$email, 'nickname'=>$nickname, 'questionid'=>$questionid, 'answer'=>$answer, 'regip' => $regip));
}
...
function uc_user_checknick($nickname) {
