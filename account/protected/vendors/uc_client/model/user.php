...
class usermodel {
	...
	function check_nicknameexists($nickname) {
		$data = $this->db->result_first("SELECT uid FROM ".BBS_DBTABLEPRE."member_profile WHERE field1='$nickname'");
		return $data;
	}
	...
	function add_user($username, $password, $email, $nickname, $uid = 0, $questionid = '', $answer = '', $regip = '') {
		...
		$this->db->query("INSERT INTO ".BBS_DBTABLEPRE."member_profile SET uid='$uid', field1='$nickname'");
		return $uid;
	}
